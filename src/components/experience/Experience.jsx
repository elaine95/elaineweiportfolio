    ...
    return(
        <div className="experience" id="experience">         
            <Fragment>
                ...
                <Timeline>
                    <Event interval={"2020 - Present"} title={"Ceridian"} subtitle={"Senior Test Engineer"}>
                        Ceridian is an HCM Company that provides Payroll, Talent, HR, Timesheet solutions. I am part of HR Development team
                        and focusing on UI automation. I design and develop UI automation framework to automate test scenarios.
                        The framework is scalable and have been used by more than 3000 end to end UI test scenarios. From time to time, 
                        ...
                        as well as to identify positive defects more efficiently. 
                    </Event>
                    <Event interval={"2018 - 2020"} title={"Paymentus"} subtitle={"Automation Engineer"}>
                        ...
                        I worked within a small team to develop a new framework from scratch that works for UI, API and IVR autoamtions. 
                        ...
                        as well as building images in Docker and Kubernetes.
                    </Event>
                </Timeline>
            </Fragment>
        </div>
